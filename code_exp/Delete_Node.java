...
public class Main {
    public class LinkedList {
        ...
        public void rev()
        {
            Node prev=null;
            Node curr=head;
            // System.out.println("1st----------> "+head.data+"  ---  "+tail.data);
            while(curr!=null)
            {
              Node temp=curr.next;
              curr.next=prev;
            ...
            // System.out.println("2nd----> "+head.data+"  ---  "+tail.data);
            Node n=head;
            head=prev;
            tail=n;
            // System.out.println("3rd----> "+head.data+"  ---  "+tail.data);
        }
